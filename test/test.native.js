...
tape( 'the function computes the log loss gradient for tiny positive values', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var p;
...
tape( 'the function computes the log loss gradient for small positive values', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var p;
...
tape( 'the function computes the log loss gradient for tiny negative values', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var p;
...
tape( 'the function computes the log loss gradient for small negative values', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var p;
